...
<?php
    ...
    if (!@mail($to, $subject, $message, $headers))
        ...
        echo "<p style='color: #fff; margin: 0; padding: 20px 0; background: #27ae60; font-size: 25px; text-align: center;'>Thanks for contacting us! We will get in touch with you soon.</p>";
?>
<?php
}
?>